...
public class RecordConfig implements Serializable
{
     ...
     * @param channelConfig 声道配置 单声道：See {@link AudioFormat#CHANNEL_IN_MONO} 双声道：See
     *            {@link AudioFormat#CHANNEL_IN_STEREO}
     * @param encodingConfig 位宽配置 8Bit： See {@link AudioFormat#ENCODING_PCM_8BIT} 16Bit: See
    ...
    public String toString()
    {
        return String.format(Locale
            .getDefault(), "录制格式： %s,采样率：%sHz,位宽：%s bit,声道数：%s", format, sampleRate, getEncoding(), getChannelCount());
    }
