...
public class RecordService extends Service
{
    ...
    public static String getFilePath()
    {
        ...
        String fileName = String.format(Locale.getDefault(),
                "rec_%s","audio");
        return String
                .format(Locale.getDefault(), "%s%s%s", fileDir, fileName, currentConfig.getFormat().getExtension());
    }

    public static void setMaxGain(float gain)
    {
        RecordHelper.getInstance().setMaxGain(gain);
    }

    public static boolean setTmpFilesDir(@NonNull String pathStr)
    {
        return RecordHelper.getInstance().setTmpFilesDir(Paths.get(pathStr));
    }
}
