package com.xiaoxuan.audio.recorderlib.recorder.wav;
...
/**
 * pcm 转 wav 工具类 http://soundfile.sapp.org/doc/WaveFormat/
 */
public class WavUtils
{
    ...
    /**
     * 生成wav格式的Header wave是RIFF文件结构，每一部分为一个chunk，其中有RIFF WAVE chunk， FMT Chunk，Fact chunk（可选）,Data chunk
     *
