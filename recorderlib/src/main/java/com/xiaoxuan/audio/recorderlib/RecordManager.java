package com.xiaoxuan.audio.recorderlib;
...
import com.xiaoxuan.audio.recorderlib.recorder.RecordConfig;
import com.xiaoxuan.audio.recorderlib.recorder.RecordHelper;
import com.xiaoxuan.audio.recorderlib.recorder.RecordService;
...
public class RecordManager
{
    ...
    public void setMaxGain(float gain) {
        RecordService.setMaxGain(gain);
    }

    public boolean setTmpFilesDir(@NonNull String tmpFilesDir)
    {
        return RecordService.setTmpFilesDir(tmpFilesDir);
    }
